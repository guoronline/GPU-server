...
- ### 2. 三维含夹杂多面体单元（节点不限，面数不限）
  ...
  - #### 单元类型编号Type_voronoi3D = 30200;（节点不限，面数不限）
    ...
    <img src="..\images\elements\Voronoi element 3D.png" alt="Voronoi element 3D" style="zoom:200%;" /><img src="..\images\elements\Interface Voronoi E 3D.png" alt="Interface Voronoi E 3D" style="zoom:200%;" />
...
- ### 4. 三维多面体单元（节点不限，面数不限）
  ...
  <img src="..\images\elements\Polyhedron element.png" alt="Polyhedron element" style="zoom:200%;" />

  ![Polyhedron element](..\images\elements\Polyhedron element.png)
